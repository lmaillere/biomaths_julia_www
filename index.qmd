...
Téléchargez et placez dans ce répertoire les fichiers [Project.toml](./Project.toml).
 <!-- et [Manifest.toml](./Manifest.toml). -->
 Ouvrez un terminal et démarrez Julia dans ce répertoire:
```{julia}
#| eval: false
julia> ]                   # package mode
