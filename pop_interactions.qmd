...
#plot!(Psurf, xsurf, ysurf, aplane, st = :surface, color = myred, alpha =.5, label = "")
```
...
GLMakie.surface(xsurf, ysurf, zsurf, 
        axis = (type=Axis3, xlabel = L"proies $x$",
        ylabel = L"prédateurs $y$"))

GLMakie.surface!(xsurf, ysurf, zplane)
```
